package io.nexstudios.internal.nms.v1_21_10.entities;
...
public class PaperMobBuilder implements MobBuilder, MobBuilderFactory {
    ...
    private static void tryMakeHostileWithNmsGoals(org.bukkit.entity.Mob mob) {
        try {
            Object nms = ((org.bukkit.craftbukkit.entity.CraftLivingEntity) mob).getHandle();
            ...
            try {
                net.minecraft.world.entity.ai.attributes.AttributeMap map = nmsMob.getAttributes();
                var ATTACK_DAMAGE = net.minecraft.world.entity.ai.attributes.Attributes.ATTACK_DAMAGE;
                var FOLLOW_RANGE  = net.minecraft.world.entity.ai.attributes.Attributes.FOLLOW_RANGE;
                var KNOCKBACK_RES = net.minecraft.world.entity.ai.attributes.Attributes.KNOCKBACK_RESISTANCE;
                var MOVE_SPEED    = net.minecraft.world.entity.ai.attributes.Attributes.MOVEMENT_SPEED;
...
//                }
            ...
            if (nms instanceof net.minecraft.world.entity.PathfinderMob pfm) {
