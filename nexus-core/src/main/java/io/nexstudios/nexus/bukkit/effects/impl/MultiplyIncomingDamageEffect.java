...
public class MultiplyIncomingDamageEffect implements NexusDamageMultiplierEffect {

    private final String expression;
    private final PlayerVariableResolver resolver;
    private final String contextKey; // z. B. "stat:<statId>" oder null

    public MultiplyIncomingDamageEffect(String expression, PlayerVariableResolver resolver) {
        this(expression, resolver, null);
    }

    public MultiplyIncomingDamageEffect(String expression, PlayerVariableResolver resolver, String contextKey) {
    ...
    public void onDamage(EntityDamageByEntityEvent event) {
        // incoming-damage: Spieler ist das Opfer (target)
