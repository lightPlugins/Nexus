...
public class AddOutgoingDamageEffect implements NexusDamageEffect {

    private final String expression;
    private final PlayerVariableResolver resolver;
    private final String contextKey; // z. B. "stat:<statId>" oder null

    public AddOutgoingDamageEffect(String expression, PlayerVariableResolver resolver) {
        this(expression, resolver, null);
    }

    public AddOutgoingDamageEffect(String expression, PlayerVariableResolver resolver, String contextKey) {
